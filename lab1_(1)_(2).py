...
Original file is located at
    https://colab.research.google.com/drive/1n99KrgPda7X80h_1HHeS5gmtlIWgEuIq
...
if score > 100:
  ...
  print("Your grade in Polish system is:", grade)
...
print("The triangle", triangle_check, "from these sides")
